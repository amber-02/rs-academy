...
import SignIn, {passAccountType} from './components/navbar/SignIn';
      ...
      <Router>
        ...
        <Routes>
          ...
          {signIn ? (
            ...
            <Route path="/studentLandingPage" element={<SignIn setUserData={setUserData} userData={userData} setSignIn={setSignIn} />} />
            </>
          )}
